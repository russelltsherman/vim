...
Plug 'fatih/vim-go'
" :GoInstallBinaries to instll required go tools to GOBIN
" :GoDoc to see documentation in local buffer
" :GoDocBrowser to open documentation in web browser
" :GoRun
" :GoBuild
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" disable gd command for vim-go - delegate to CoC
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
